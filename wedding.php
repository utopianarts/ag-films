...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="w3-row-padding" id="myGrid" style="margin-bottom:128px">
      <div class="w3-third">
        <img src="image/still/1_wedding/1.jpg" style="width:100%">
        <img src="image/still/1_wedding/4.jpg" style="width:100%">
        <img src="image/still/1_wedding/7.jpg" style="width:100%">
        <img src="image/still/1_wedding/10.jpg" style="width:100%">
        <img src="image/still/1_wedding/13.jpg" style="width:100%">
        <img src="image/still/1_wedding/15.jpg" style="width:100%">
      </div>

      <div class="w3-third">
        <img src="image/still/1_wedding/2.jpg" style="width:100%">
        <img src="image/still/1_wedding/5.jpg" style="width:100%">
        <img src="image/still/1_wedding/8.jpg" style="width:100%">
        <img src="image/still/1_wedding/11.jpg" style="width:100%">
        <img src="image/still/1_wedding/14.jpg" style="width:100%">
        <img src="image/still/1_wedding/16.jpg" style="width:100%">
      </div>

      <div class="w3-third">
        <img src="image/still/1_wedding/3.jpg" style="width:100%">
        <img src="image/still/1_wedding/6.jpg" style="width:100%">
        <img src="image/still/1_wedding/9.jpg" style="width:100%">
        <img src="image/still/1_wedding/12.jpg" style="width:100%">
      </div>
    </div>
