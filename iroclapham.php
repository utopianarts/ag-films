  ...
  <body>
    ...
    <div class="video-container m-auto px-1 lg:flex">
      <div class="video-frame">
        <iframe src="https://www.youtube.com/embed/habnH-BRdls" frameborder="0" allowfullscreen="allowfullscreen"></iframe>
      </div>
    </div>
    ...
    <div class="stills-container">
      ...
      <div class="stills-frame">
        ...
        <div class="still">
          <div class="still-img">
            <!-- <img src="MOTION/7_iro_sushi_clapham/IRO_CLAPHAM_THUMBNAIL.jpg" alt="WEDDING" class="imageS"></img> -->
          </div>
        </div>
