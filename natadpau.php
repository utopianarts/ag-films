  ...
  <body>
    ...
    <div class="video-container m-auto px-1 lg:flex">
      <div class="video-frame">
        <iframe src="https://www.youtube.com/embed/fURTdnOvCjg" frameborder="0" allowfullscreen="allowfullscreen"></iframe>
      </div>
    </div>
    ...
    <div class="stills-container">
      ...
      <div class="stills-frame">
        ...
        <div class="still">
          <div class="still-img">
            <img src="image/MOTION/5_natadpau_images/1.jpg" alt="WEDDING" class="imageS"></img>
          </div>
        </div>

        <div class="still">
          <div class="still-img">
            <img src="image/MOTION/5_natadpau_images/2.jpg" alt="FOOD" class="imageS"></img>
          </div>
        </div>

        <div class="still">
          <div class="still-img">
            <img src="image/MOTION/5_natadpau_images/3.jpg" alt="EVENTS THUMBNAIL" class="imageS"></img>
          </div>
        </div>

        <div class="still">
          <div class="still-img">
            <img src="image/MOTION/5_natadpau_images/4.jpg" alt="EVENTS THUMBNAIL" class="imageS"></img>
          </div>
        </div>
