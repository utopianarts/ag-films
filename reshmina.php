  ...
  <body>
    ...
    <div class="stills-container">
      ...
      <div class="stills-frame">
        ...
        <div class="still">
          <div class="still-img">
            <img src="image/MOTION/6_rashmina_weds_abinas/1.jpg" alt="WEDDING" class="imageS"></img>
          </div>
        </div>

        <div class="still">
          <div class="still-img">
            <img src="image/MOTION/6_rashmina_weds_abinas/2.jpg" alt="FOOD" class="imageS"></img>
          </div>
        </div>

        <div class="still">
          <div class="still-img">
            <img src="image/MOTION/6_rashmina_weds_abinas/3.jpg" alt="EVENTS THUMBNAIL" class="imageS"></img>
          </div>
        </div>

        <div class="still">
          <div class="still-img">
            <img src="image/MOTION/6_rashmina_weds_abinas/4.jpg" alt="EVENTS THUMBNAIL" class="imageS"></img>
          </div>
        </div>
